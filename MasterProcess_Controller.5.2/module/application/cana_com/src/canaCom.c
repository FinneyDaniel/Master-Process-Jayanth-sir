...
void CANA_fnCmdsForAnaOPs(uint16_t ui16cabinetID, uint16_t ui16nodeID,
...
void CANA_fnCmdsForAnaOPs(uint16_t ui16cab_ID, uint16_t ui16nodeID,
...
void CANA_fnTx()
{
    ...
    CANA_tzAnaOPParams.CANA_tzAOV[0][0].AOV1 = var1;

    CANA_fnCmdsForAnaOPs(3, 0, &CANA_tzAnaOPParams);
