...

{
    ...
    CAN_setupMessageObject(CANA_BASE, CANA_mMAILBOX_1, 0x141101F2,
                           CAN_MSG_FRAME_EXT, CAN_MSG_OBJ_TYPE_RX, 0,
                           CAN_MSG_OBJ_NO_FLAGS, CANA_mEIGHT_BYTE);

// LPCIO
    CAN_setupMessageObject(
            CANA_BASE, CANA_mMAILBOX_2, CANA_mRX_MSGID1, CAN_MSG_FRAME_EXT,
    ...
    //LHCIO
    CAN_setupMessageObject(
            CANA_BASE, CANA_mMAILBOX_3, CANA_mRX_MSGID2, CAN_MSG_FRAME_EXT,
            CAN_MSG_OBJ_TYPE_RX, 0X1F0FFFF0,
            CAN_MSG_OBJ_USE_ID_FILTER | CAN_MSG_OBJ_USE_EXT_FILTER, //QUERY FOR MASTER OPERATING STATE
            CANA_mEIGHT_BYTE);
...

{
    ...
    CAN_setupMessageObject(
            CANB_BASE, CANA_mMAILBOX_7, 0x14160103, CAN_MSG_FRAME_EXT,
