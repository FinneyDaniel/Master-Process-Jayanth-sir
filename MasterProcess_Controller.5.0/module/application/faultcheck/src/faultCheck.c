...
static bool faultLPCIO1_fnReset(uint16_t ui16DIFaultType, uint16_t timerValueReset);

static bool faultLHCIO1_fnSet(uint16_t ui16DIFaultType1, uint16_t timerValueSet1);
static bool faultLHCIO1_fnReset(uint16_t ui16DIFaultType1, uint16_t timerValueReset1);

static bool faultLPCIO2_fnSet(uint16_t ui16DIFaultType, uint16_t timerValueSet);
static bool faultLPCIO2_fnReset(uint16_t ui16DIFaultType, uint16_t timerValueReset);

static bool faultLHCIO2_fnSet(uint16_t ui16DIFaultType1, uint16_t timerValueSet1);
static bool faultLHCIO2_fnReset(uint16_t ui16DIFaultType1, uint16_t timerValueReset1);
...
void faultCheck(void)
{
    ...
    if (MATHConvtzRegs.AISensorOXS101 > 25.0f)
    {
...
static bool faultLHCIO1_fnReset(uint16_t ui16DIFaultType, uint16_t timerValueReset)
{
...
static bool faultLHCIO2_fnReset(uint16_t ui16DIFaultType, uint16_t timerValueReset)
{
