...
union CANA_tzLPCAIFLT_IOREGS CANA_tzLPCAIFaultRegs[CANA_mTOTAL_LPCNODES];
union CANA_tzLHCAIFLT_IOREGS CANA_tzLHCAIFaultRegs[CANA_mTOTAL_LHCNODES];
...
bool can_fndequedata(can_tzcirc_buff *ptr, uint16_t *data, uint32_t *msgID,
                     uint16_t *DLC);
void CANA_fnCmdsForDigIOs(uint16_t ui16unitID, uint16_t ui16cab_ID, uint16_t ui16nodeID,
                          uint16_t digitalIO);

void CANA_fnCmdsForAnaOPVs(uint16_t ui16unitID, uint16_t ui16cab_ID, uint16_t ui16nodeID,
                           can_tzAnaOPParams *ptrAO_V);

void CANA_fnCmdsForAnaOPIs(uint16_t ui16unitID, uint16_t ui16cab_ID, uint16_t ui16nodeID,
...

{
    ...
    case IO_AIBLK1_MSGID:
        ...
        case LPC_30:
            ...
            CANA_tzAIData_IORegs[CANA_mLPC30_IO].AI0_Data =
                    ((msgDataIO[0] << 8) | (msgDataIO[1])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLPC30_IO].AI1_Data =
                    ((msgDataIO[2] << 8) | (msgDataIO[3])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLPC30_IO].AI2_Data =
                    ((msgDataIO[4] << 8) | (msgDataIO[5])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLPC30_IO].AI3_Data =
                    ((msgDataIO[6] << 8) | (msgDataIO[7])) * 0.001;
            break;

        case LPC_31:

            CANA_tzAIData_IORegs[CANA_mLPC31_IO].AI0_Data =
                    ((msgDataIO[0] << 8) | (msgDataIO[1])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLPC31_IO].AI1_Data =
                    ((msgDataIO[2] << 8) | (msgDataIO[3])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLPC31_IO].AI2_Data =
                    ((msgDataIO[4] << 8) | (msgDataIO[5])) * 0.001;
    ...
    case IO_AIBLK2_MSGID:
        ...
        case LPC_30:
            ...
            CANA_tzAIData_IORegs[CANA_mLPC30_IO].AI4_Data =
                    ((msgDataIO[0] << 8) | (msgDataIO[1])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLPC30_IO].AI5_Data =
                    ((msgDataIO[2] << 8) | (msgDataIO[3])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLPC30_IO].AI6_Data =
                    ((msgDataIO[4] << 8) | (msgDataIO[5])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLPC30_IO].AI7_Data =
                    ((msgDataIO[6] << 8) | (msgDataIO[7])) * 0.001;
            break;
...

{
    ...
    case IO_AIBLK1_MSGID:
        ...
        case LHC_10:
            ...
            CANA_tzAIData_IORegs[CANA_mLHC10_IO].AI0_Data =
                    ((msgDataIO[0] << 8) | (msgDataIO[1])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLHC10_IO].AI1_Data =
                    ((msgDataIO[2] << 8) | (msgDataIO[3])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLHC10_IO].AI2_Data =
                    ((msgDataIO[4] << 8) | (msgDataIO[5])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLHC10_IO].AI3_Data =
                    ((msgDataIO[6] << 8) | (msgDataIO[7])) * 0.001;
            break;

        case LHC_11:

            CANA_tzAIData_IORegs[CANA_mLHC11_IO].AI0_Data =
                    ((msgDataIO[0] << 8) | (msgDataIO[1])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLHC11_IO].AI1_Data =
                    ((msgDataIO[2] << 8) | (msgDataIO[3])) * 0.001;
            CANA_tzAIData_IORegs[CANA_mLHC11_IO].AI2_Data =
                    ((msgDataIO[4] << 8) | (msgDataIO[5])) * 0.001;
    ...
    case IO_AIBLK2_MSGID:
        ...
        case LHC_11:
            ...
            CANA_tzAIData_IORegs[CANA_mLHC11_IO].AI4_Data =
                    ((msgDataIO[0] << 8) | (msgDataIO[1])) * 0.001;
                          ...
                          uint16_t digitalIOStatus)
{
    CAN_setupMessageObject(
            CANA_BASE, CAN_mMAILBOX_8,
              (ui16unitID << 8) | (ui16cab_ID << 4) | (ui16nodeID) | CANA_mTX_IOMSGID1,
    ...
    CAN_sendMessage(CANA_BASE, CAN_mMAILBOX_8, CANA_mTHREE_BYTE,
                    ui16txMsgDataIO);
                           ...
                           can_tzAnaOPParams *ptrAOV)
{
    ...
    CANA_BASE,
                           CAN_mMAILBOX_8,
                           (ui16unitID << 8) | (ui16cab_ID << 4) | (ui16nodeID) | CANA_mTX_IOMSGID3,
                           ...
                           can_tzAnaOPParams *ptrAOI)
{
    ...
    CANA_BASE,
                           CAN_mMAILBOX_8,
                           (ui16unitID << 8) | (ui16cab_ID << 4) | (ui16nodeID) | CANA_mTX_IOMSGID2,
                           CAN_MSG_FRAME_EXT, CAN_MSG_OBJ_TYPE_TX, 0,
                           CAN_MSG_OBJ_NO_FLAGS,
                           CAN_mLEN8);
