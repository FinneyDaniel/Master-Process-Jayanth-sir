...
uint16_t uiDataLength1 = 0, uiDataLength2 = 0, uiDataLength3 = 0, uiDataLength4 = 0;
...
void CANA_fnTask(void)
{
    ...
    // VSC Processing
       ...
       can_fndequedata(&uiRxbufferVSC, uirxPrcsMsgVSC, &u32msgID4,
                           &uiDataLength4);
       ...
       cana_fnmsgPrcsVSC(canA_VSCbuff.uiNodeID, canA_VSCbuff.uiMsgType, uirxPrcsMsgVSC);
}
