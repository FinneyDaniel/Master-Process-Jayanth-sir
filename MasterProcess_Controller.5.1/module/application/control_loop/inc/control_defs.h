...
extern void Waterloop_fnCommandIOTURNONVFD(int32 i32nodeID,
                                           float32_t f32VoltMotorSpeedCntrl1);
extern void Waterloop_fnCommandIOTURNOFFVFD(int32 i32nodeID,
                                            float32_t f32VoltMotorSpeedCntrl1);

extern void control_waterloop(void);
extern void cana_fnH2DryerCommands1(int32 i32nodeID, int16_t i16gpioNumber,
                            bool ui16GPIOStatus);
...
extern PI_CONTROLLER CONTROL_tzGlycolLp;
extern union CONTROL_FLTS_REG CONTROLtzFaultRegs;
extern uint32_t ui32NodePresent;
extern uint16_t ui16SafeShutDownFlg,ui16InstShutDownFlg;

extern uint16_t ui16SiteCommandTurnONPMP3;
extern uint16_t ui16VoltMotorSpeedCntrl, ui16VoltMotorSpeedCntrl1;
extern float32_t f32VFDVoltageCAN;
extern float32_t f32MotorSpeed;
extern uint16_t ui16PIgain;
