...
void Waterloop_fnCommandIOTURNONVFD(int32 i32nodeID,
                                    float32_t f32VoltMotorSpeedCntrl);
void Waterloop_fnCommandIOTURNOFFVFD(int32 i32nodeID,
                                     float32_t f32VoltMotorSpeedCntrl);
void cana_fncmdIO_Node_EBV_Valve(int32 i32nodeID, float32 f32EBVOutvalue);
...
void control_waterloop(void)
{
    ...
    // Operating Water Solenoid Valve based on LVL101
        ...
        {
            //cana_fnCmdsForDigIOs(CANA_mTXLHC101_IO, 1); // Turn ON water solenoid valve
        }
